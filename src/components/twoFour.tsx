...
export default function TwoFour() {
  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      {/* Decorative Elements */}
      <div className="absolute top-10 left-10 w-32 h-32 bg-[#82da99]/10 rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#82da99]">
            Earn 24/7
          </h2>
        ...
        >
          <button className="bg-[#82da99] text-white px-8 py-3 rounded-full font-semibold
            hover:bg-[#82da99]/90 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
            Start Earning Today
          </button>
        </motion.div> */}
      </div>
